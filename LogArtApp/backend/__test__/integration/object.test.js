...
describe('Pruebas de Objetos', () => {
  ...
  describe('POST /api/v1/objects/', () => {
    it('debería crear un objeto exitosamente', async () => {
      ...
      const response = await request(app)
        ...
        .attach('imageUrl', path.join(__dirname, 'imagesTest', 'test-image.jpg'));
    ...
    it('debería fallar al crear un objeto con datos incompletos', async () => {
      ...
      expect(response.statusCode).toBe(400);
      expect(response.body).toHaveProperty('error', true);
      expect(response.body.message).toBe('Both name and discipline are required');
    ...
    it('debería fallar al crear un objeto con un nombre duplicado', async () => {
      ...
      expect(response.statusCode).toBe(400);
      expect(response.body).toHaveProperty('error', true);
      expect(response.body.message).toBe('Cannot create two objects with the same name');
  ...
  describe('PUT /api/v1/objects/:objectId', () => {
    it('debería actualizar un objeto exitosamente sin imagen', async () => {
      ...
      expect(response.body.object.imageUrl).toBe('/public/images/objects/test-image.jpg');
      expect(response.body).toHaveProperty('message', 'Object updated successfully');
    ...
    it('debería actualizar un objeto exitosamente con imagen', async () => {
      ...
      const response = await request(app)
        ...
        .attach('imageUrl', path.join(__dirname, 'imagesTest', 'test-image-2.jpg'));

      expect(response.statusCode).toBe(200);
      expect(response.body).toHaveProperty('object');
      expect(response.body.object.name).toBe(updatedData.name);
      expect(response.body.object.description).toBe(updatedData.description);
      expect(response.body.object.imageUrl).toMatch(/\/public\/images\/objects\/\d+\.jpg$/);
      expect(response.body).toHaveProperty('message', 'Object updated successfully');
    ...
    it('debería fallar al actualizar un objeto sin permisos', async () => {
      ...
      expect(response.body).toHaveProperty('error', true);
      expect(response.body).toHaveProperty('message', 'You are not authorized to update this object');
  ...
  describe('DELETE /api/v1/objects/:objectId', () => {
    ...
    it('debería fallar al eliminar un objeto sin permisos', async () => {
      ...
      expect(response.statusCode).toBe(403);
      expect(response.body).toHaveProperty('error', true);
      expect(response.body).toHaveProperty('message', 'You are not authorized to delete this object');
  ...
  describe('GET /api/v1/objects/details/:objectId', () => {
    it('debería obtener un objeto exitosamente como propietario', async () => {
      ...
      expect(response.body.object.description).toBe('Descripción del objeto 15');
    ...
    it('debería obtener un objeto exitosamente como administrador', async () => {
      ...
      expect(response.body.object.description).toBe('Descripción del objeto 16');
    ...
    it('debería fallar al obtener un objeto sin permisos', async () => {
      ...
      expect(response.statusCode).toBe(403);
      expect(response.body).toHaveProperty('error', true);
      expect(response.body).toHaveProperty('message', 'You are not authorized to view this object');
    });
