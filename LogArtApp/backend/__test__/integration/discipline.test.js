  ...
  describe('GET /api/v1/disciplines/', () => {
    it('debería obtener todas las disciplinas', async () => {
      const disciplinesData = [
        ...
        { name: 'Canciones', description: 'Disciplina relacionada con canciones' },
        { name: 'Videojuegos', description: 'Disciplina relacionada con videojuegos' },
      ];
    ...
    it('debería manejar errores del servidor', async () => {
      ...
      expect(response.body).toHaveProperty('message', 'Error obteniendo disciplinas');
