...
El objetivo principal fue crear una plataforma funcional que permitiera a los usuarios no solo catalogar obras, sino también preservar las impresiones subjetivas y reflexiones asociadas a ellas. Para ello, se desarrolló una aplicación Fullstack utilizando el stack MERN (MongoDB, Express.js, React, Node.js). El \textit{backend} expone una API RESTful segura para la gestión de datos, mientras que el \textit{frontend} ofrece una interfaz de usuario intuitiva y responsiva. La aplicación incluye gestión completa de usuarios con autenticación basada en JWT, funcionalidades CRUD para objetos culturales y comentarios personales, y un panel de administración con herramientas de moderación y visualización de estadísticas de uso, entre muchas otras cosas.

El desarrollo del proyecto siguió una metodología iterativa e incremental, priorizando la calidad del software mediante la ejecución de pruebas unitarias, de integración y \textit{End-To-End}. Para dar soporte a estas prácticas de calidad, se adoptó una cultura DevOps basada en la contenedorización con Docker y Docker Compose, junto con la implementación de flujos de Integración y Entrega Continua (CI/CD) en GitHub Actions, automatizando así tanto la fase de validación como la publicación de imágenes.
