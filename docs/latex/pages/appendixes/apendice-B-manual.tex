...
El funcionamiento detallado de cada sección del \textit{dashboard} es intuitivo y se presenta a través de diferentes pestañas, además de estar claramente definido en \ref{rf:adminFuncionalidades}
